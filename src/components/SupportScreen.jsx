...
const SupportScreen = () => {
  ...
  const translations = {
    ru: {
      ...
      telegramText:
        "Самый быстрый способ получить помощь - написать в наш Telegram канал. Наши специалисты ответят в течение 24 часов.",
      email: "Электронная почта",
      emailText:
        "Для официальных запросов и жалоб используйте email: support@prosurvey.uz",
    ...
    uz: {
      ...
      telegramText:
        "Yordam olishning eng tezkor usuli - bizning Telegram kanalimizga yozish. Bizning mutaxassislar 24 soat ichida javob beradi.",
      email: "Elektron pochta",
      emailText:
        "Rasmiy so'rovlar va shikoyatlar uchun email ishlatish: support@prosurvey.uz",
    ...
    <div className="flex flex-col h-screen bg-gradient-to-br from-gray-50 to-purple-50">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 pb-30 custom-scrollbar">
        <div className="text-center mb-4">
          ...
          <h2 className="text-3xl font-bold text-[#5E5AF6] mb-2">{t.title}</h2>
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100 mb-3">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-800 mb-2">{t.telegram}</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">{t.telegramText}</p>
              <button
          ...
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-purple-500 to-purple-600 flex items-center justify-center flex-shrink-0">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-white">
                ...
                4l-8 5-8-5V6l8 5 8-5v2z" fill="currentColor"/>
              </svg>
            </div>
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-800 mb-2">{t.email}</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">{t.emailText}</p>
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100 mb-3">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-green-500 to-green-600 flex items-center justify-center flex-shrink-0">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-white">
                <path d="M12 2C6.5 2 2 
                6.5 2 12s4.5 10 10 
                10 10-4.5 10-10S17.5 
                2 12 2zm4.2 14.2L11 
                13V7h1.5v5.2l4.5 
                2.7-.8 1.3z" fill="currentColor"/>
              </svg>
            </div>
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">{t.workingHours}</h3>
          ...
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 flex items-center justify-center flex-shrink-0">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-white">
                ...
                9.27l-5 4.87 1.18 6.88L12 
                17.77l-6.18 3.25L7 
                14.14 2 9.27l6.91-1.01L12 
                2z" fill="currentColor"/>
              </svg>
            </div>
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">{t.responseTime}</h3>
              <div className="space-y-2">
                <div className="flex items-center gap-3">
        ...
        <div className="mt-3 p-4 bg-blue-50 rounded-xl border border-blue-200">
          <div className="flex items-start gap-3">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-blue-600 flex-shrink-0 mt-0.5">
              ...
              6.48 2 12s4.48 10 10 
              10 10-4.48 10-10S17.52 2 
              12 2zm-2 15l-5-5 
              1.41-1.41L10 14.17l7.59-7.59L19 
              8l-9 9z" fill="currentColor"/>
            </svg>
            <p className="text-sm text-blue-800 leading-relaxed">{t.note}</p>
          </div>
        </div>
      </div>
